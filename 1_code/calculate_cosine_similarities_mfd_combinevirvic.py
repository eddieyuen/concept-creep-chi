...
foundations_path = '/Users/kawaiyuen/nlpworkshop/concept-creep-chi/0_data/wordlist/mfd_short.json'   # MFD
...
# Combine virtue and vice words under the same foundation name
combined_foundations = {}
for foundation_name in ["care", "fair", "loya", "auth", "sanc"]:
    virtue_words = foundations[f"{foundation_name}_vir"]
    vice_words = foundations[f"{foundation_name}_vic"]
    combined_words = virtue_words + vice_words
    combined_foundations[foundation_name] = combined_words
print(combined_foundations)

# Models
model_folder_path = '/Users/kawaiyuen/nlpworkshop/concept-creep-chi_raw/models'
models = load_word2vec_models(model_folder_path)

similarities = calculate_cosine_similarities(models, concepts, combined_foundations)
...
csv_filepath = '/Users/kawaiyuen/nlpworkshop/concept-creep-chi/2_pipeline/preprocessed/cos-sim_mfd.csv'
