...
transposed_csv_file = '/Users/kawaiyuen/nlpworkshop/concept-creep-chi/2_pipeline/preprocessed/frequency_cmfd_rmdup_transposed.csv'
...
with open(transposed_csv_file, 'w', newline='') as file:
    ...
    for i, year in enumerate(header[2:]):
