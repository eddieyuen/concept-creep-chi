...
# Read the CSV file
df = pd.read_csv('/Users/kawaiyuen/nlpworkshop/concept-creep-chi/2_pipeline/tmp/relativefreq_cmfd.csv')
...
# Save the plot
plt.savefig('/Users/kawaiyuen/nlpworkshop/concept-creep-chi/3_output/relativefreq/cultural-salience_cmfd_moving-avg.png', dpi=300)
