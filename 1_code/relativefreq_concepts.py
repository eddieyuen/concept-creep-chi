...
# Specify file paths
frequency_file_path = '/Users/kawaiyuen/nlpworkshop/concept-creep-chi/2_pipeline/preprocessed/frequency_concepts.csv'
token_counts_file_path = '/Users/kawaiyuen/nlpworkshop/concept-creep-chi/2_pipeline/preprocessed/token_counts.csv'
result_file_path = '/Users/kawaiyuen/nlpworkshop/concept-creep-chi/2_pipeline/tmp/relativefreq_concepts.csv'
...
scaled_data.to_csv(result_file_path)

print("Scaled frequency data processed and stored in", result_file_path)