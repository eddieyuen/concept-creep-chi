...
for file_number in range(1, 11):
    ...
    file_name = f"controls_sb_{file_number}_transposed.csv"
    file_path = f"/Users/kawaiyuen/nlpworkshop/concept-creep-chi/2_pipeline/preprocessed/semantic_breadth_control_words/{file_name}"
...
output_path = '/Users/kawaiyuen/nlpworkshop/concept-creep-chi/2_pipeline/tmp/controls_semantic_breadth_mean.csv'
